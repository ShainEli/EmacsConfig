...
(defun ramsay/get-rust-src-path ()
  ...
  (let* ((command (concat "rustc --print sysroot"))
	...
	(concat strip-path "\\lib\\rustlib\\src\\rust\\src")
      (concat strip-path "/Users/zhangshuai/.rustup/toolchains/stable-x86_64-apple-darwin/lib/rustlib/src/rust/src"))))
...
(defun ramsay/set-rust-ld-library-path ()
  ...
  (let* ((command (concat "rustc --print sysroot"))
	...
	(concat strip-path "\\lib\\")
      (concat strip-path "/Users/zhangshuai/.rustup/toolchains/stable-x86_64-apple-darwin/lib/"))))
